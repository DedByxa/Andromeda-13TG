...
/datum/reagent/toxin/pestkiller/organic
	name = "Естественный убийца вредителей"
...
/datum/reagent/toxin/fakebeer //disguised as normal beer for use by emagged brobots
	name = "ПиВО" // Тут было B33r, типо фейковый Beer. Перевёл как ПиВО, специально акцент большие буквы
	description = "Специально разработанное седативное средство, замаскированное под пиво. Оно вызывает мгновенный сон у своей жертвы."
...
/datum/reagent/toxin/tetrodotoxin
	name = "Тетродотоксин"
	description = "Нейротоксин без цвета, запаха и вкуса, обычно содержащийся в печени животных отряда четвероногих."
	silent_toxin = TRUE
...
/datum/reagent/toxin/gatfruit
	name = "Фитотоксин"
	description = "Яд, вырабатываемый редким и неуловимым растением гатфрут."
	liver_damage_multiplier = 0
	toxpwr = 1
