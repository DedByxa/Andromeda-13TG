...
#define SM_POWER_EXTERNAL_IMMEDIATE "Внешнее усиление мощности"
/// How much energy we get from external factors that are applied over time.
#define SM_POWER_EXTERNAL_TRICKLE "Внешний источник питания"
/// How much energy is gained from the temperature. Enabled by gas.
#define SM_POWER_HEAT "Прирост тепловой мощности за счет газа"
...
#define SM_POWER_POWERLOSS "Затухание внутренней мощности"
...
#define SM_POWER_POWERLOSS_GAS "Отрицание распада газовой мощности"
...
#define SM_TEMP_LIMIT_GAS "Термостойкость газа"
...
/// Order matters, depends on base resistance.
#define SM_TEMP_LIMIT_LOW_MOLES "Низкая термостойкость"

/// How much we are multiplying our zap energy.
#define SM_ZAP_BASE "Базовая передача разряда"
/// How much we are multiplying our zap energy because of gas factors.
#define SM_ZAP_GAS "Газовый модификатор передачи разряда"
/// Delamination types.
