...
/obj/item/food/pie/cream/proc/stun_and_blur(mob/living/victim, can_splat_on, datum/thrownthing/throwing_datum)
	...
	victim.visible_message(span_warning("Личико [victim] получило КРЕМпай от [src]!"), span_userdanger("Вы получили КРЕМпай личика от [src]!"))
...
/obj/item/food/pie/amanita_pie
	...
	desc = "Сладкий и вкусный пирог с грибочками. Это мой пирог, я его надкусил!"
