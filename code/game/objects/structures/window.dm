...
/obj/structure/window/reinforced/attackby_secondary(obj/item/tool, mob/user, params)
	if(resistance_flags & INDESTRUCTIBLE)
		balloon_alert(user, "слишком стойкий!")
...
/obj/structure/window/reinforced/examine(mob/user)
	...
	switch(state)
		if(RWINDOW_SECURE)
			. += span_notice("Оно было завинчено односторонними винтами, вам нужно было бы нагреть их, чтобы иметь хоть какой-то шанс вытащить их обратно.")
		if(RWINDOW_BOLTS_HEATED)
